...
export default class InstructionMode {
  ...
  public addr: (arg: Value, processor: Processor, memory: Memory) => Value;
  public format: (arg: Value, arg_size: number) => string;
  public readonly base_length: number;
  public readonly length_modifier: number;
  public readonly text: string;

  public constructor(args: {
    addr: (arg: Value, processor: Processor, memory: Memory) => Value;
    format: (arg: Value, arg_size: number) => string;
    base_length: number;
