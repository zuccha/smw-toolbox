...
describe.each(modes)("$mode", ({ mode, arg }) => {
  describe("A 8-bit", () => {
    test.each`
      ...
      ${0x00} | ${{}}                       | ${{ flag_z: 1 }}
      ${0x00} | ${{ flag_c: 1 }}            | ${{ a: 0x0001, flag_c: 0 }}
      ${0x01} | ${{ flag_c: 1 }}            | ${{ a: 0x0002, flag_c: 0 }}
      ...
      ${0x40} | ${{}}                       | ${{ a: 0x0040, flag_v: 1 }}
      ${0x80} | ${{}}                       | ${{ a: 0x0080, flag_n: 1 }}
      ${0xc0} | ${{}}                       | ${{ a: 0x00c0, flag_n: 1, flag_v: 1 }}
      ${0x00} | ${{ a: 0xc000 }}            | ${{ flag_z: 1 }}
      ${0x01} | ${{ flag_n: 1 }}            | ${{ a: 0x0001, flag_n: 0 }}
      ${0x01} | ${{ flag_v: 1 }}            | ${{ a: 0x0001, flag_v: 0 }}
      ${0x01} | ${{ flag_z: 1 }}            | ${{ a: 0x0001, flag_z: 0 }}
  ...
  describe("A 16-bit", () => {
    test.each`
      value     | initialProcessor            | expectedProcessor
      ${0x0000} | ${{}}                       | ${{ flag_z: 1 }}
      ${0x0000} | ${{ flag_c: 1 }}            | ${{ a: 0x0001, flag_c: 0 }}
      ${0x0001} | ${{ flag_c: 1 }}            | ${{ a: 0x0002, flag_c: 0 }}
      ...
      ${0x4000} | ${{}}                       | ${{ a: 0x4000, flag_v: 1 }}
      ${0x8000} | ${{}}                       | ${{ a: 0x8000, flag_n: 1 }}
      ${0xc000} | ${{}}                       | ${{ a: 0xc000, flag_n: 1, flag_v: 1 }}
      ${0x0000} | ${{ a: 0x00c0 }}            | ${{}}
      ${0x0001} | ${{ flag_n: 1 }}            | ${{ a: 0x0001, flag_n: 0 }}
      ${0x0001} | ${{ flag_v: 1 }}            | ${{ a: 0x0001, flag_v: 0 }}
      ${0x0001} | ${{ flag_z: 1 }}            | ${{ a: 0x0001, flag_z: 0 }}
    `(`ADC ${mode} [$initialProcessor]`, (params) => {
