  ...
  return mode === ThemeMode.Dark
    ? createTheme({
        ...
        settings: {
          ...
          selection: themeDarkColor.highlight1,
          selectionMatch: themeDarkColor.highlight1,
          lineHighlight: themeDarkColor.highlight2,
        ...
        styles: [
          ...
          { tag: t.labelName, color: "#b45f8a" },
          { tag: t.macroName, color: "#f6ad55" },
    ...
    : createTheme({
        ...
        settings: {
          ...
          selection: themeLightColor.highlight1,
          selectionMatch: themeLightColor.highlight1,
          lineHighlight: themeLightColor.highlight2,
        ...
        styles: [
          ...
          { tag: t.labelName, color: "#662b49" },
          { tag: t.macroName, color: "#ed8936" },
