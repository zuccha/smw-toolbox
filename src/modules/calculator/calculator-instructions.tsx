...
export default function CalculatorInstructions({
  ...
  return (
    <div class="calculator-instructions">
      ...
      >
        <div class="calculator-instructions-sections">
          <div>
            <div class="calculator-instructions-section-label">General:</div>
            <div>
          ...
          <div>
            <div class="calculator-instructions-section-label">
              Editor Actions:
            </div>
            <div>
          ...
          <div>
            <div class="calculator-instructions-section-label">Settings:</div>
            <table>
              <thead>
                <tr>
                  <th>Name</th>
